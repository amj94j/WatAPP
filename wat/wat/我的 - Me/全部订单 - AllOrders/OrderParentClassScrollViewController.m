...
#import "OrderParentClassScrollViewController.h"

@interface OrderParentClassScrollViewController ()<UIGestureRecognizerDelegate>

@property(strong, nonatomic)UIScrollView *scrollView;

@end

@implementation OrderParentClassScrollViewController

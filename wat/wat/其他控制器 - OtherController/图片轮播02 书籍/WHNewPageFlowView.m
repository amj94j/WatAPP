...
#import "WHNewPageFlowView.h"
#import "WHPGIndexBannerSubiew.h"
@interface WHNewPageFlowView ()
...
@implementation WHNewPageFlowView
    ...
    switch (self.orientation) {
        case NewPagedFlowViewOrientationHorizontal:{
            ...
            for (NSInteger i = self.visibleRange.location; i < self.visibleRange.location + _visibleRange.length; i++) {
                WHPGIndexBannerSubiew *cell = [_cells objectAtIndex:i];
...
- (UIView *)dequeueReusableCell{
    WHPGIndexBannerSubiew *cell = [_reusableCells lastObject];
    if (cell)
    {

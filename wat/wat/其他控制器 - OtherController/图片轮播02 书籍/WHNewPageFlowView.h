...
@interface WHNewPageFlowView : UIView<UIScrollViewDelegate>
 ...
 *  @return <#return value description#>
 */
- (CGSize)sizeForPageInFlowView:(WHNewPageFlowView *)flowView;
 ...
 *  @param flowView   <#flowView description#>
 */
- (void)didScrollToPage:(NSInteger)pageNumber inFlowView:(WHNewPageFlowView *)flowView;
 ...
 *  @return <#return value description#>
 */
- (NSInteger)numberOfPagesInFlowView:(WHNewPageFlowView *)flowView;
 ...
 *  @return <#return value description#>
 */
- (UIView *)flowView:(WHNewPageFlowView *)flowView cellForPageAtIndex:(NSInteger)index;
